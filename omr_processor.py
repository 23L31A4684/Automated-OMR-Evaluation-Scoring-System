...
def evaluate_omr(image_path, student_id, version):
    print(f"Version received: {version}, type: {type(version)}")
    ...
    return {"student_id": student_id, "version": version, "total_score": total, "answers": answers[:10]}
